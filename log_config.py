...
receiver_own = "wcadaydayup@163.com, wuzhangan@ceair.com"#bbb201@126.com, 
rceiver_list_own = ["wcadaydayup@163.com", "wuzhangan@ceair.com"]#"bbb201@126.com",
...
def output2ui(msg, level=UI_LOG_LEVEL):
    ...
    # if level >= 6:
    #     import smtplib
    #     smtp = smtplib.SMTP("smtp.ceair.com")
    #     smtp.login("wuzhangan@ceari.com", "52012836@ceair")
    #     smtp.sendmail("wuzhangan@ceari.com", "wcadaydayup@163.com", msg)
    #     smtp.close()
